...
namespace Recombee.ApiClient.ApiRequests
{
    ...
    public class AddPurchase : Request
    {
        ...
        public AddPurchase (string userId, string itemId, DateTime? timestamp = null, bool? cascadeCreate = null, double? amount = null, double? price = null, double? profit = null): base(HttpMethod.Post, 1000)
        {
            this.userId = userId;
            this.itemId = itemId;
