...
{
    /// <summary>Recommend Item Segments to Item</summary>
    /// <remarks>Recommends Segments from a [Segmentation](https://docs.recombee.com/segmentations.html) that are the most relevant to a particular item.
    ...
    /// </remarks>
    public class RecommendItemSegmentsToItem : Request
    {
        ...
        {
            return string.Format("/recomms/items/{0}/item-segments/", ItemId);
        }
