...
namespace Recombee.ApiClient.ApiRequests
{
    ...
    /// <remarks>Recommends the top Segments from a [Segmentation](https://docs.recombee.com/segmentations) for a particular user, based on the user's past interactions.
