...
namespace Recombee.ApiClient.ApiRequests
{
    ...
    /// <remarks>Recommends users that are likely to be interested in the given item.
    ...
    public class RecommendUsersToItem : Request
    {
        ...
        /// <summary>If an item of the given *itemId* doesn't exist in the database, it creates the missing item.</summary>
        ...
        /// The AI that optimizes models to get the best results may optimize different scenarios separately or even use different models in each of the scenarios.
        /// </param>
        /// <param name="cascadeCreate">If an item of the given *itemId* doesn't exist in the database, it creates the missing item.</param>
        ...
        /// </param>
        public RecommendUsersToItem (string itemId, long count, string scenario = null, bool? cascadeCreate = null, bool? returnProperties = null, string[] includedProperties = null, string filter = null, string booster = null, Logic logic = null, Dictionary<string, string> reqlExpressions = null, double? diversity = null, Dictionary<string, object> expertSettings = null, bool? returnAbGroup = null): base(HttpMethod.Post, 50000)
        {
            this.itemId = itemId;
            this.count = count;
