...
{
    /// <summary>Update Manual ReQL Segment</summary>
    /// <remarks>Update definition of the Segment.
    /// </remarks>
    public class UpdateManualReqlSegment : Request
    {
        private readonly string segmentationId;
        /// <summary>ID of the Segmentation to which the updated Segment belongs</summary>
        public string SegmentationId
        {
            get {return segmentationId;}
        }
        private readonly string segmentId;
        /// <summary>ID of the Segment that will be updated</summary>
        ...
        /// <param name="segmentationId">ID of the Segmentation to which the updated Segment belongs</param>
        /// <param name="segmentId">ID of the Segment that will be updated</param>
        ...
        /// </param>
        public UpdateManualReqlSegment (string segmentationId, string segmentId, string filter, string title = null): base(HttpMethod.Post, 10000)
        {
