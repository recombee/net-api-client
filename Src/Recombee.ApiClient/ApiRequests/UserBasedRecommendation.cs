...
namespace Recombee.ApiClient.ApiRequests
{
    ...
    public class UserBasedRecommendation : Request
    {
        ...
        /// <summary>ID of the user whose personalized recommendations are to be generated.</summary>
        ...
        /// <param name="userId">ID of the user whose personalized recommendations are to be generated.</param>
